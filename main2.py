...
def main_menu():
  ...
  print("                           BATTLESHIPS         ")
  print("                        ------------------")
  print("Try to sink all 8 ships as fast as possible.")
  print("You will start out with 50 bullets.")
  print("When the program prompts you, type in a row and a column in orderto fire a bullet.")
  print("If you do not manage to sink all the ships when your bullets run out, you will lose the game.")
  print("")
